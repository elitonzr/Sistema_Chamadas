// https://www.toptal.com/developers/keycode
	...
	// background-color:#e67f2d;	Periapical
	// background-color:#d377bd;	Boca Toda
	// background-color:#5ab0d0;	Doc
	// background-color:#47d867;	Tomo
	// background-color:#d0d5d8;	Pan/Tele
	// background-color:#ebe41b;	Scaneamento
...
jQuery(document).ready(function($) {
	...
	$("body").on('keydown', function(e) {
		...
		// FILA PERIAPICAL.
		if(visualiza.val() == 0){
			document.getElementById('Atual').style.backgroundColor = '#e67f2d';			
			...
			document.getElementById('Atual').style.backgroundColor = '#d377bd';
			...
			document.getElementById('Atual').style.backgroundColor = '#5ab0d0';
			...
			document.getElementById('Atual').style.backgroundColor = '#47d867';
			...
			document.getElementById('Atual').style.backgroundColor = '#d0d5d8';
			...
			document.getElementById('Atual').style.backgroundColor = '#ebe41b';
